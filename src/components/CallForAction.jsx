      ...
      <div className="w-full lg:w-1/2 mb-8 lg:mb-0 text-left">
        ...
        <form className="space-y-6 ">
          <div>
            ...
            <div className="border-b border-black w-full mt-2 h-1"></div>
            <input
              type="text"
              id="name"
              className="w-full p-3 mt-2 text-black bg-transparent focus:outline-none"
          ...
          <div>
            <button
              type="button" // Removed form submission logic
              className="w-full bg-yellow-500 hover:bg-yellow-300 text-white py-3 rounded-lg"
            >
              Submit
            </button>
          </div>
